...
//! 6. soft-delete 检查引用 → 20803 BIZ_PROCESS_IN_USE（挂 t_process_chain_step.process_id）
...
//! `insert_part_with_next_process` 是本 sub-file 独享的 raw SQL 构造
//! （绕开 part 域 CRUD），保留为本地 fn。chain + step 行构造同样保留 inline。
...
// ===========================================================================
//  process 域独享 helper（绕开 part 域 CRUD）
// ===========================================================================
