...
mod tests {
    ...
    fn constants_match_python_values() {
        ...
        assert_eq!(code::BIZ_PART_BATCH_NOT_HELD_BY_WORKER, 20114);
        assert_eq!(code::BIZ_PART_ALREADY_CANCELLED, 20115);
        ...
        assert_eq!(code::BIZ_DELIVERY_NOTE_LOCKED_PART, 21420);
