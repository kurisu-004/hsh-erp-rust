...
//!
//! 2026-09-11 备注：worker_pool::refill_for_worker 与本次新增的
//! worker_pool::auto_allocate_for_process 都依赖本函数；refactor f5b1ec0 误删
//! `sync_from_batch_change` 后 worker_pool / part scan 链路整体编译失败。
//! 现重新加回本文件以恢复 worker_pool 编译。
